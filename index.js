...
// DEBUG=* node debug ./bin/homebridge -D -P ../homebridge-mqtt-hsb-light/
...
module.exports = function(homebridge){
    ...
    homebridge.registerAccessory('homebridge-mqtt-hsb-light', 'MQTT-HSB-LIGHT', MQTT_HSB);
};
...
MQTT_HSB.prototype = {
    ...
    getServices: function() {
        ...
        informationService
            .setCharacteristic(Characteristic.Manufacturer, 'MQTT HSB Light')
            .setCharacteristic(Characteristic.Model, 'MQTT HSB Light version-1')
            .setCharacteristic(Characteristic.SerialNumber, 'MQTT HSB Light Serial');
